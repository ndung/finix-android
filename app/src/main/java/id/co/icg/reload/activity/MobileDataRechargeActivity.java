...
public class MobileDataRechargeActivity extends BaseActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (String prefix : Global.tselPrefixes) {
            prefixBillerMap.put(prefix, "101");
        }
        for (String prefix : Global.isatPrefixes) {
            prefixBillerMap.put(prefix, "113");
        }
        for (String prefix : Global.xlPrefixes) {
            prefixBillerMap.put(prefix, "103");
        }
        for (String prefix : Global.axisPrefixes) {
            prefixBillerMap.put(prefix, "104");
        }
        for (String prefix : Global.threePrefixes) {
            prefixBillerMap.put(prefix, "118");
        }
        for (String prefix : Global.boltPrefixes) {
            prefixBillerMap.put(prefix, "049");
        }
        ...
        tvTitle.setText(R.string.mobile_data_recharge);
